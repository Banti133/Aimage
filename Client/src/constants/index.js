export const surpriseMePrompts = [
    ...
    'A dream of a floating island filled with lush vegetation and waterfalls',
    'A portal to another dimension opening up in the middle of a forest',
    'A glimpse of an underwater city inhabited by mermaids and sea creatures',
    'A city built on the back of a giant turtle, slowly traversing a vast desert',
    'A library filled with books that whisper secrets to those who read them',
    'A stylized portrait-oriented depiction where a tiger serves as the dividing line between two contrasting worlds. To the left, fiery reds and oranges dominate as flames consume trees. To the right, a rejuvenated forest flourishes with fresh green foliage. The tiger, depicted with exaggerated and artistic features, stands tall and undeterred, symbolizing nature enduring spirit amidst chaos and rebirth.',
    ...
    'A painting with a man creating the universe, in the style of psychedelic illustration, hyper-detailed illustrations, vivid colors, bold, colorful portraits, necronomicon illustrations, concert poster, tumblewave',
    'Style of Yoshiyuki Sadamoto:”Angel’s Egg, cell shading, dreamy vibrance, surreal, grainy, vintage anime, overlapping visual channels, interference, dystopian sky, tilted” Classic Anime; in the woods, the transformation of man to god, this is truly everlasting beauty. The very moment where the glorious light of godly power merges with man. Camera looking down. Very vibrant and surreal. Dark Smokey 80’s anime.',
    'A cinematic realism image. A close-up of a Kalki standing on the street in golden hour backlighting. Warm color palette with natural light. Realistic with cinematic photography.',
  ];